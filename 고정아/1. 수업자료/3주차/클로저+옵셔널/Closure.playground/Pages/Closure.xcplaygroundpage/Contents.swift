...
let countt = { ( strring:String) -> Int in

    return strring.count
...
func returnTwo (num1: Int, num2: Int){
    
result = num1 * num2
    
}

returnTwo(num1: 2, num2: 3)
...
let multiplyTwoNumber2: (Int, Int) -> Int = { $0 * $1 }
